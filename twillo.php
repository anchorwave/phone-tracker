...
if( isset( $_GET['tw_phone_call'] ) && is_numeric( $_GET['tw_phone_call'] ) && $_GET['tw_phone_call'] > 0)
{
...
if( isset( $_GET['tw_phone_record'] ) && is_numeric( $_GET['tw_phone_record'] ) && $_GET['tw_phone_record'] > 0)
{
